...
export function getStars(reviews, size) {
  ...
  return (
    <div className="flex">
      {Array.from({ length: fullStars }, () => (
        <Star size={size} absoluteStrokeWidth strokeWidth={2} fill="#000000" />
      ))}
      {halfStar && (
        <StarHalf
          size={size}
          ...
          strokeWidth={2}
          fill="#000000"
          className={size === 36 ? "-mr-9" : "-mr-6"}
        />
      )}
      {halfStar && (
        <StarHalf size={size} absoluteStrokeWidth strokeWidth={2} className="-scale-x-100" />
      )}
      {Array.from({ length: starsLeft }, () => (
        <Star size={size} absoluteStrokeWidth strokeWidth={2} />
      ))}
    </div>
  );
}
