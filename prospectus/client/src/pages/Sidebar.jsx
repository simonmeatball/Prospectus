    ...
    return (
        ...
        >
            <nav className="flex min-w-[240px] flex-col gap-1 p-2 font-sans text-base font-normal text-blue-gray-700">
                <div
                    role="button"
                    className="flex items-center w-full p-3 transition-all rounded-lg hover:bg-blue-100"
                >
                ...
                <button className="flex items-center w-full p-3 transition-all rounded-lg hover:bg-blue-100">
