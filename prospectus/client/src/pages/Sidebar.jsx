...
const Sidebar = () => {
  ...
  const getPostsWithTags = (desiredTag) => {
    ...
    return posts.filter(
      (post) => post.tags.some((tag) => tag.toLowerCase() === desiredTagLower) // Convert each tag to lowercase
    );
  };

  const displayPostsByCategory = () => {
    // ALL THE POST CATEGORIES
            ...
            <div className="flex flex-col items-center w-full px-4">
              ...
              <div className="flex flex-wrap justify-center w-full">
                {maxLikes.length > 0 ? (
                  ...
                  <div className="text-center mt-6">No posts available</div>
                )}
              </div>
            </div>
          </div>
    ...
    <>
      ...
      >
        <nav className="flex min-w-[300px] flex-col gap-1 p-2 font-sans z-100 ">
          <Link
            to="/"
            className="flex items-center w-40 p-3 rounded-lg hover:bg-gray-200 mt-16"
          >
          ...
          <button
            ...
            className="flex items-center w-40 p-3 rounded-lg hover:bg-gray-200"
          >
          ...
          <button
            onClick={() => setActiveCategory("ucla")}
            className="flex items-center justify-center w-40 h-20 p-2 rounded-lg hover:bg-gray-200"
          >
            <img src={ucla} className="w-40 h-15" />
          </button>

          <button
            onClick={() => setActiveCategory("usc")}
            className="flex items-center justify-center w-40 h-20 p-2 rounded-lg hover:bg-gray-200"
          >
