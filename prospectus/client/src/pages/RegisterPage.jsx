    ...
    <div style={{ userSelect: "none" }}>
      ...
      <div className="font-sans">
        <div class="bg-[url('../images/homebg.png')]  w-full bg-cover bg-no-repeat bg-center">
          ...
          <img
            src={Logo1}
            className="absolute animate-bounce  p-0 border-0 left-0  mt-12 max-w-full h-auto"
            alt="Positioned Image"
            draggable="false"
          />
          <img
            src={Logo2}
            className="absolute animate-bounce  p-0 border-0 right-0  mt-12 max-w-full h-auto"
            alt="Positioned Image"
            draggable="false"
          />
          ...
          <form
            ...
            class=" relative max-w-sm mx-auto mt-12 bg-local"
          >
            <div class="mb-6">
              <label
                for="email"
        ...
        <div className="mt-12 bg-white text-black">
          <h1 className=" text-center mt-8 text-7xl text-cyan-600 font-semibold">
            {" "}
            Not a member yet?
          </h1>
          <p className="text-center mt-8 mb-10 text-2xl font-semibold ">
            Boost your career search with Prospectus!
          </p>
          ...
          <div className="flex justify-left p-8" alt="Reasons">
            <div className="mb-10 " alt="Reason1">
              ...
              <p className="ml-4 text-2xl font-medium ">
                ...
                <p className="mt-1 text-xl font-normal">
                  {" "}
                  Learn how to customize your resume for particular job
                  applications, increasing your chances of standing out.{" "}
                </p>{" "}
              </p>
            </div>
            ...
            <div alt="Reason2">
              ...
              <p className="ml-4 text-2xl font-medium ">
                ...
                <p className="mt-1 text-xl font-normal">
                  {" "}
                  Receive guidance from professionals, and get insights on
                  formatting, grammar, and tailoring your resume for specific
                  industries.{" "}
                </p>{" "}
              </p>
            </div>
            ...
            <div alt="Reason3">
              ...
              <p className="ml-4 text-2xl font-medium ">
                ...
                <p className="mt-1 text-xl font-normal">
                  {" "}
                  Our resume reviewer app provide cost-effective options
                  compared to hiring a professional resume writer.{" "}
                </p>{" "}
              </p>
            </div>
            ...
            <div alt="Reason4">
              ...
              <p className="ml-4 text-2xl font-medium ">
                ...
                <p className="mt-1 text-xl font-normal">
                  {" "}
                  Learn about trends in resume writing to stay up-to-date in an
